...
struct qti_smem_toc_header {
	...
	uint32_t num_entries; /* number of valid qti_smem_toc_entry */
...
struct qti_smem_partition_header {
	...
	uint32_t offset_free_uncached; /* end of allocated uncached */
	uint32_t offset_free_cached; /* start of allocated cached */
	uint32_t reserved[3]; /* reserved; not validated */
} __packed;
